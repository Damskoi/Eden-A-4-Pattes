...
<body>
	<div class="container-fluid">
		...
		<aside class="row">
			<!-- espace pub -->
			<div class="col-md-12"  id="pub" style="background-color: black; color: white">
				<p>espace pub</p>
			</div>

			<!-- Commentaire -->
			<div class="col-md-12" id="commentaire" style="background-color: white">
		...
		<section class="row" style="text-align: center; margin: 20px; ">
			<div class="col-md-6" id="VisiteVideo">
